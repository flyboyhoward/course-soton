...
classname = {imgSets_train.Description}; %get names of each class
...
imgTest_name = sort_nat(newCa); %sort image name by its number, because matlab read image based on file create time instead of the number order in folder